 ...
 * @author zyuiop
 */
public class v1_8_R2 implements ReflectionFunctions {
	@Override
	...
	public void playEndermanTeleport(Location location, Player player) {
		player.playSound(location, Sound.valueOf("ENDERMAN_TELEPORT"), 1, 1);
	}

	@Override
	public ScoreboardSign createScoreboardSign(Player player, String text) {
		return new ScoreboardSign_v1_8_R2(player, text);
	}
}
