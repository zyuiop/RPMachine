...
public class SignsListener implements Listener {
    ...
    public void onSignPlace(SignChangeEvent event) {
        ...
        if (line0.equalsIgnoreCase("Shop")) {
            ...
            if (price == null || bundleSize == null || action == null) {
                ...
                try {
                    ...
                    if (action.equalsIgnoreCase("achat")) {
                        if (!tt.checkDelegatedPermission(ShopPermissions.CREATE_BUY_SHOPS))
                            return;
            ...
            if (!tt.checkDelegatedPermission(ShopPermissions.CREATE_PLOT_SHOPS))
                return;
    ...
    public void onSignClick(PlayerInteractEvent event) {
        ...
        if (sign == null)
            ...
            if (sign instanceof ItemShopSign) {
                ...
                p.sendMessage(ChatColor.YELLOW + "Owner (Name/UUID) : " + sign.owner().displayable());
