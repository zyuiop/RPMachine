...
public class ProjectsManager extends FileEntityStore<Project> implements LegalEntityRepository<Project> {
    ...
    public boolean canBuild(Player player, Location location) {
        ...
        return project == null || project.canBuild(player);
    }
    ...
    public boolean canInteractWithBlock(Player player, Location location) {
        Project project = getZoneHere(location);
        return project == null || project.canInteractWithBlock(player);
    }

    public boolean canInteractWithEntity(Player player, Location location) {
        Project project = getZoneHere(location);
        return project == null || project.canInteractWithEntity(player);
    }
